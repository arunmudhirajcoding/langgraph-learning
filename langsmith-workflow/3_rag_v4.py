...
PDF_PATH = os.path.join(script_dir, "islr.pdf")  # <-- change to your PDF filename
INDEX_ROOT = Path(".indices") # created a indices where embeddings will stored
INDEX_ROOT.mkdir(exist_ok=True)

# ----------------- helpers (traced) -----------------
@traceable(name="load_pdf")
def load_pdf(path: str):
    return PyPDFLoader(PDF_PATH).load()  # list[Document]
...
def build_vectorstore(splits, embed_model_name: str):
    ...
    model="nomic-embed-text",  # or "bge-small-en", "mxbai-embed-large"
